...
const DATA_DIR = existsSync(join(__dirname, 'data')) ? join(__dirname, 'data') : join(__dirname, '..', 'data');
mkdirSync(DATA_DIR, { recursive: true });

const db = new Database(join(DATA_DIR, 'title-accounts.db'));

// WAL mode for concurrent reads + busy timeout for writes
...
db.exec(`
  ...
  -------------------------------------------------
  -- Sessions — JWT tracked for revocation
  -------------------------------------------------
  ...
  -------------------------------------------------
  -- Subscriptions — Stripe audit trail
  -------------------------------------------------
  ...
  -------------------------------------------------
  -- Saved Properties — agent farm lists
  -------------------------------------------------
  ...
  -------------------------------------------------
  -- Farm Areas — saved search zones with alert opt-in
  -------------------------------------------------
  ...
  -------------------------------------------------
  -- Conversations — chat history (Unlimited tier)
  -------------------------------------------------
  ...
  -------------------------------------------------
  -- Usage Log — per-request tracking for rate limiting + analytics
  -------------------------------------------------
